...
df1 <- read.csv("C:/Users/file_location/SI/Figure S17_MACC_HS.csv")
df2 <- read.csv("C:/Users/file_location/SI/Figure S18_MACC_LS.csv")
...
file_path_1 <- file.path(save_directory, "FigS17.png")
ggsave(file_path_1, combined_plot_1, bg = "white", width = 7, height = 9, units = "in", dpi = 600)

file_path_2 <- file.path(save_directory, "FigS18.png")
