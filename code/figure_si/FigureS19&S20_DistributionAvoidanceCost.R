...
df1 <- read.csv("C:/Users/file_location/Figure S19_MACC_HS.csv")
df2 <- read.csv("C:/Users/file_location/Figure S20_MACC_LS.csv")
...
file_path_1 <- file.path(save_directory, "FigS19.png")
ggsave(file_path_1, combined_plot_1, bg = "white", width = 7, height = 9, units = "in", dpi = 600)

file_path_2 <- file.path(save_directory, "FigS20.png")
